      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.subtitle}>Start querying your data with AI</Text>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.inputWrapper}>
                <Ionicons name="person-outline" size={16} color="#4A5568" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  value={name}
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={[
                ...
                <TouchableOpacity onPress={() => setShowConfirm(!showConfirm)} style={styles.eyeBtn}>
                  <Ionicons name={showConfirm ? 'eye-off-outline' : 'eye-outline'} size={16} color="#4A5568" />
                </TouchableOpacity>
              </View>
...
const styles = StyleSheet.create({
  ...
  appName: { color: '#E2E8F0', fontSize: 32, fontWeight: '800', letterSpacing: -1 },
  tagline: { color: '#4A5568', fontSize: 13, marginTop: 6, letterSpacing: 0.3 },
  card: {
  ...
  inputError: { borderColor: '#FC818160' },
  ...
  eyeBtn: { padding: 12 },
  fieldError: { color: '#FC8181', fontSize: 11, marginTop: -4 },
  primaryBtn: {
